...
public class AddProductActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addProudctBtn = findViewById(R.id.addProudctBtn);
        ...
        addProudctBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                inputData();
            }
    ...
    private void addProduct() {
        ...
        if(image_uri == null){
            ...
            String filePatnandName = "product_images/"+""+timestamp;
